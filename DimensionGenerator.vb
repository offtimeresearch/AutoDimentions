...
Sub Main()
    ...
    Try
        ...
        Logger.Info("V0.4 staged mode: attachment dimensions remain deferred until normal spool chains/centerlines are verified.")
        ...
        MessageBox.Show( _
            ...
            "DimensionGenerator V0.4")


    Catch ex As Exception

        MessageBox.Show( _
            "DimensionGenerator V0.4 failed:" & vbCrLf & vbCrLf & _
            ex.Message, _
            "Auto Dimensions")
