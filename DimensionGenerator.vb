...
Sub Main()
    ...
    Try
        ...
        Logger.Info("V0.11: true reference-member mapping + one global native vertical chain + improved vertical spacing; attachments deferred.")
        ...
        MessageBox.Show( _
            ...
            "DimensionGenerator V0.11")


    Catch ex As Exception

        MessageBox.Show( _
            "DimensionGenerator V0.11 failed:" & vbCrLf & vbCrLf & _
            ex.Message, _
            "Auto Dimensions")
