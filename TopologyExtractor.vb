...
Sub DrawElbowArc( _
    ...
    Dim radiusPixels As Double = _
        Math.Sqrt( _
            (a.X - c.X) * (a.X - c.X) + _
            (a.Y - c.Y) * (a.Y - c.Y))


    If radiusPixels < 1 Then
        Exit Sub
    End If


    Dim v1x As Double = a.X - c.X
    Dim v1y As Double = a.Y - c.Y

    Dim v2x As Double = b.X - c.X
    Dim v2y As Double = b.Y - c.Y
    ...
    svg.AppendLine( _
        ...
        Num(a.X) & " " & Num(a.Y) & _
        " A " & _
        Num(radiusPixels) & " " & Num(radiusPixels) & _
